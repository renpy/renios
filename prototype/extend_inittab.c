...
PyMODINIT_FUNC initpydict(void);
...
PyMODINIT_FUNC initgltexture(void);
PyMODINIT_FUNC initgl2polygon(void);
PyMODINIT_FUNC initgl2mesh(void);
...
void renios_extend_inittab(void) {
    ...
    PyImport_AppendInittab("pygame_sdl2.power", initpower);
    ...
    PyImport_AppendInittab("renpy.pydict", initpydict);
    ...
    PyImport_AppendInittab("renpy.gl2.gl2polygon", initgl2polygon);
    PyImport_AppendInittab("renpy.gl2.gl2mesh", initgl2mesh);
