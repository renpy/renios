...
# Touch these, so they don't have to be regenerated by broken code.
try touch Include/Python-ast.h
try touch Python/Python-ast.c
...
try deduplicate $BUILDROOT/lib/libpython2.7.a
